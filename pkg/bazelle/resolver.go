...
func (b *Bazelle) Imports(c *config.Config, r *rule.Rule, f *rule.File) []resolve.ImportSpec {
	return nil
}
...
func (b *Bazelle) Embeds(r *rule.Rule, from label.Label) []label.Label {
	return nil
}
...
// heuristics.
func (b *Bazelle) Resolve(c *config.Config, ix *resolve.RuleIndex, rc *repo.RemoteCache, r *rule.Rule, imports interface{}, from label.Label) {
}
